...
\begin{IEEEeqnarray*}{rCl}
  A & = & ``\mathrm{Area~enclosed~by}~TS\mathrm{-diagram}" \\
...
The increase in entropy while heat was added to the system was later canceled about by a decrease in entropy while heat was removed from the system.

The area enclosed by the Carnot cycle on the $PV$-diagram represents $W_{\mathrm{tot}}$, the total work done by the gas on the environment (116 J).
Since $P dV = dW$, integrating $P dV$ (finding the enclosed area) yields the work.

The area enclosed by the Carnot cycle on the $TS$-diagram represents $Q_{\mathrm{tot}}$, the net heat transferred to the gas (116 J).
