...
\br
Key & \mch{$m_c$ (g)} & \mch{$m_cw$ (g)} & \mch{$m_m$ (g)} & \mch{$T_iw$ (℃)} & \mch{$T_im$ (℃)} & \mch{$T_f$ (℃)} \\
\mr
...
\br
Key & \mch{$c$ (J / (kg K))} & \mch{$c_\mathrm{true}$ (J / (kg K))} & \mch{$c - c_\mathrm{true}$ (J / (kg K))} \\
\mr
...
\begin{IEEEeqnarray}{rCl}
\Delta c & = & \sqrt{ \left(\frac{\partial c}{\partial H} \Delta H \right)^2 + \left(\frac{\partial c}{\partial t} \Delta t \right)^2 + \left(\frac{\partial c}{\partial m_w} \Delta m_w \right)^2 + \left(\frac{\partial c}{\partial T_i} \Delta T_i \right)^2 + \left(\frac{\partial c}{\partial T_f} \Delta T_f \right)^2 }\label{eq:cpart1uncertainty} \\
  & = & \frac{Ht}{m_w (T_f - T_i)} \sqrt{ \left(\frac{\Delta H}{H} \right)^2 + \left(\frac{\Delta t}{t}\right)^2 + \left(\frac{\Delta m_w}{m_w}\right)^2 + \left(\frac{\Delta T_i}{T_f - T_i}\right)^2 + \left(\frac{\Delta T_f}{T_f - T_i}\right)^2 } \nonumber
\end{IEEEeqnarray}
