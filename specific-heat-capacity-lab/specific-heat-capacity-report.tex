...
It might be noticed that the initial temperature of the water ($T_{iw}$) was different in each trial for parts 2 and 3.
...
Looking at equation \ref{eq:cpart2and3}, even if $T_{iw}$ were to increase/decrease, $T_f$ would also increase/decrease in such a way to keep the calculated $c$ value the same.
