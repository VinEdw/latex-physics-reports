...
\br
Key & \mch{$m_c$ (g)} & \mch{$m_{cw}$ (g)} & \mch{$m_m$ (g)} & \mch{$T_{iw}$ (℃)} & \mch{$T_{im}$ (℃)} & \mch{$T_f$ (℃)} \\
\mr
...
\mr
1     & 4700 & 100         & 4186               & 600 & 100           \\
2     & 900  & 200         & 910                & 10 & 200           \\
3     & 140  & 40          & 130                & 9 & 40             \\
4     & 900  & 100         & 910                &\-38 & 100          \\
5     & 600  & 100         & 750                &\-200 & 100         \\
\br
\end{tabular}\end{indented}\end{table}
...
& = & \frac{m_w c_w (T_f - T_{iw})}{m_m (T_{im} - T_f)} \Bigg[ \left(\frac{\Delta m_m}{m_{m}}\right)^2 + \left(\frac{\Delta m_w}{m_w}\right)^2 \nonumber \\
