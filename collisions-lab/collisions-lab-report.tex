...
% Custom macro
\gdef\vin{r@{.}l@{ ± }r@{.}l} % Used for decimal aligning & ± aligning
...
\br
Trial&\multicolumn{4}{l}{$m_B$ (g)}&\multicolumn{4}{l}{$m_G$ (g)}&\multicolumn{4}{l}{$v_B$ (cm/s)}&\multicolumn{4}{l}{$v_G$ (cm/s)}&\multicolumn{4}{l}{$u_B$ (cm/s)}&\multicolumn{4}{l}{$u_G$ (cm/s)}\\
\mr
...
\br
Trial&\multicolumn{4}{l}{$P_i$ (g m/s)}&\multicolumn{4}{l}{$P_f$ (g m/s)}&\multicolumn{4}{l}{$P_f - P_i$ (g m/s)}&Momentum conserved?\\
\mr
...
\begin{indented}\lineup\item[]\begin{tabular}{@{}l\vin\vin\vin l}
\br
Trial&\multicolumn{4}{l}{$K_i$ (mJ)}&\multicolumn{4}{l}{$K_f$ (mJ)}&\multicolumn{4}{l}{$K_f - K_i$ (mJ)}&Prediction supported?\\
\mr
