...
\begin{IEEEeqnarray*}{rCl}
  V & = & I R
\end{IEEEeqnarray*}
and the power dissipated by each component could be calculated as the product of current and voltage.
\begin{IEEEeqnarray*}{rCl}
  P & = & V I
\end{IEEEeqnarray*}
...
This supports the idea that the Kirchhoff's rules were applied correctly.
